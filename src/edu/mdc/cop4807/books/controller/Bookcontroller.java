 ...
 */
@WebServlet(name = "BookServlet", urlPatterns = { "/books" }, initParams = {
...
public class Bookcontroller extends HttpServlet {
	...
	private void updateBookList(HttpServletRequest request, HttpServletResponse response, String title,
			String firstname, String lastname, String publisher) throws ServletException, IOException {
